...
INSERT-CELL-VALUE.
    PERFORM VARYING VAL-IDX FROM 1 BY 1 UNTIL VAL-IDX > 9
        ...
        PERFORM TEST-SQUARE
            ...
            DISPLAY "next.." LINE 11
            ACCEPT PRESS-ENTER LINE 12
    ...
    *> tested all numbers
    GOBACK
    DISPLAY "go back from " LINE 11
    DISPLAY LEVEL LINE 11 COL 15 
    ACCEPT PRESS-ENTER LINE 12
.
...
TEST-SQUARE.
    ...
    DIVIDE LIDX BY 3 GIVING TIDX-START
    DIVIDE LIDY BY 3 GIVING TIDY-START
    ...
    *> table indexes start from 1
    ...
    PERFORM VARYING TIDX FROM TIDX-START BY 1 UNTIL TIDX = TIDX-LIM
        PERFORM VARYING TIDY FROM TIDY-START BY 1 UNTIL TIDY = TIDY-LIM
            ...
            *> DISPLAY CELL-VALUE(CIDX)    LINE 3 COL 25
            *> DISPLAY TABLEY(TIDX,TIDY)    LINE 4 COL 25
            *> DISPLAY TEST-RES            LINE 5 COL 25
            *> DISPLAY TIDX-LIM    LINE 6 COL 25
            *> DISPLAY TIDY-LIM   LINE 7 COL 25
            *> DISPLAY TIDX                LINE 8 COL 25
            *> DISPLAY TIDY                LINE 9 COL 25
            *> DISPLAY "next next square.." LINE 11
            *> ACCEPT PRESS-ENTER LINE 12
